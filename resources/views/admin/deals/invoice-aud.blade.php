...
<div class="section">
    <table class="item-table">
        ...
        <tr>
            ...
            <th style="width: 50%;text-align: center;font-size: 12px;font-weight: bold" class="right-align">Total</th>
        </tr>
        </thead>
        <tbody>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 40%; vertical-align: top; padding-left: 10px; border-left: 2px solid #ccc;" class="delivery-info">
                <table style="width: 100%; border-collapse: collapse; font-size: 11px; color: #333;">
                    ...
                    <tr>
                        <td style="padding: 8px; text-align: right; border: 1px solid #ccc;">Subtotal:</td>
                        <td style="padding: 8px; text-align: right; border: 1px solid #ccc;">${{$deal->subtotal}}</td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; text-align: right; border: 1px solid #ccc;">Freight (ex-GST):</td>
                    ...
                    <tr style="font-weight: bold; background-color: #f2f2f2;">
                        <td style="padding: 8px; text-align: right; border: 1px solid #ccc;">Total:</td>
...
<div class="section payment-instructions">
    ...
    <p>
        {!! nl2br(e($companyDetail->bank_details ?? '')) !!}
    </p>
</div>
