...
<head>
	<meta charset="utf-8">
	<title>Bulk Shipping Invoice</title>
</head>
...
<body>
	...
	<table cellpadding="0" cellspacing="0" border="0" style="width:100%;border:none;">
		<tr>
			...
			<td style="width:22%;vertical-align:top;text-align:right;border:none;padding-left:8px;">
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;border:none;">
					<tr>
						<td style="color:#111;font-size:12px;white-space:nowrap;"><b>Date {{ date('d/m/Y') }}</b></td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<table cellpadding="0" cellspacing="0" border="0"
		...
		<thead>
			<tr style="background:#f0f2f5;">
				<th
					style="border:1px solid #b0b7c3;padding:8px 5px;text-align:center;color:#111;font-size:10px;letter-spacing:0.5px;">
					<b>#</b></th>
				<th
					style="border:1px solid #b0b7c3;padding:8px 5px;text-align:center;color:#111;font-size:10px;letter-spacing:0.5px;">
					<b>Description</b></th>
		...
		<tbody>
			@foreach($items as $index => $item)
				<tr style="vertical-align:top;">
					<td
						style="border:1px solid #b0b7c3;padding:8px 5px;text-align:center;vertical-align:middle;font-size:10px;">
						{{ $index + 1 }}</td>
					<td
	...
	@else
		<table cellpadding="0" cellspacing="0" border="0" style="width:100%;border:none;">
			<tr>
				<td style="font-size:11px;color:#111;width:15%;padding:3px 0;"><b>NAME:</b></td>
				<td style="font-size:11px;color:#111;width:85%;padding:3px 0;"><b>Atarah Group P/L</b></td>
			</tr>
			<tr>
				<td style="font-size:11px;color:#111;width:15%;padding:3px 0;"><b>BSB:</b></td>
				<td style="font-size:11px;color:#111;width:85%;padding:3px 0;"><b>012606</b></td>
			</tr>
			<tr>
				<td style="font-size:11px;color:#111;width:15%;padding:3px 0;"><b>ACCOUNT:</b></td>
				<td style="font-size:11px;color:#111;width:85%;padding:3px 0;"><b>797503878</b></td>
			</tr>
		</table>
	@endif
	...
	@else
		<table cellpadding="0" cellspacing="0" border="0" style="width:100%;border:none;">
			<tr>
				<td colspan="2" style="font-size:12px;color:#111;padding-bottom:8px;"><b>For all USD payments to ZMAN
			...
			<tr>
				...
				<td style="font-size:10px;color:#111;width:75%;padding:3px 0;"><b>012606</b></td>
			</tr>
			<tr>
